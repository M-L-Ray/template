...
\renewcommand\qedsymbol{\faDiceD20}%证毕符号
...
\definecolor{mypropfr}{HTML}{007799}
\definecolor{myexamplefr}{HTML}{000000}
\definecolor{mydefinitfr}{HTML}{003399}
\definecolor{mycolfr}{HTML}{006699}
\definecolor{mynotefr}{HTML}{777777}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TCOLORBOX SETUPS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%================================
